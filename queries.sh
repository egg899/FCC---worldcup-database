...
#echo $($PSQL "SELECT winner_id FROM games WHERE round = 'Final' AND year ='2018'")
echo $($PSQL "SELECT teams.name FROM teams INNER JOIN games ON games.winner_id = teams.team_id WHERE round = 'Final' AND year = '2018' ")
